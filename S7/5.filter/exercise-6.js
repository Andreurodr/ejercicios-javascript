...
const legends = streamers.filter((youtubers) => {
    if (youtubers.age > 35) youtubers.gameMorePlayed = youtubers.gameMorePlayed.toUpperCase()
     return youtubers.gameMorePlayed.toLowerCase().includes("legends");
    });
