...
const mappedStreamers = streamers.map((youtuber) => (youtuber.name))

input$$.addEventListener("input", (() => console.log(mappedStreamers.filter((youtubers) => (youtubers.toLowerCase().includes(input$$.value.toLowerCase()))))));
